      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="max-w-4xl mx-auto mb-8">
            <h2 className="text-2xl md:text-4xl font-bold mb-6 text-foreground leading-tight">
              <span className="text-primary">60% of arable land</span>, but Africa imports{" "}
              <span className="text-primary">$50B+ of food</span>
            </h2>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 rounded-full">
            ...
            <span className="text-primary font-semibold">Transforming African Agriculture Daily</span>
          </div>
        </div>
      </div>
    </section>
