      ...
      {showWelcome && (
        <Card className="mb-6 border-leaf-200 dark:border-leaf-800 bg-gradient-to-r from-leaf-50 to-leaf-100 dark:from-leaf-900/30 dark:to-leaf-900/10">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-medium">Farm Dashboard</CardTitle>
            <CardDescription>
              Manage your farm operations with AI-powered insights
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm">
              Monitor your farm conditions, get crop recommendations, track IoT sensors, and access market data all in one place.
            </p>
          </CardContent>
          <CardFooter className="flex justify-between">
            ...
            <Button className="text-xs">Take the farm tour</Button>
          </CardFooter>
        </Card>
      )}
