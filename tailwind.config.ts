	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'ai-glow': {
					'0%, 100%': { 
						boxShadow: '0 0 20px hsl(var(--ai-glow) / 0.4), 0 0 40px hsl(var(--ai-glow) / 0.2)',
						transform: 'scale(1)'
					},
					'50%': { 
						boxShadow: '0 0 30px hsl(var(--ai-glow) / 0.6), 0 0 60px hsl(var(--ai-glow) / 0.3)',
			...
			animation: {
				...
				'ai-ring': 'ai-ring 4s linear infinite',
